...
- [x] 1.1 Lint przechodzi: `npm run lint` — 57361ec
- [x] 1.2 Build przechodzi (typecheck + Astro check): `npm run build` — 57361ec
- [x] 1.3 Testy jednostkowe nie regresują: `npm test` — 57361ec

#### Manual

- [x] 1.4 Niezalogowany użytkownik wchodzący na `/flashcards` jest przekierowany na `/auth/signin`
- [x] 1.5 Zalogowany użytkownik bez fiszek widzi empty-state z przyciskiem do `/generate`
- [x] 1.6 Zalogowany użytkownik z fiszkami widzi pełną listę

### Phase 2: Globalny NavBar

#### Automated

- [x] 2.1 Lint przechodzi: `npm run lint` — 2b10d34
- [x] 2.2 Build przechodzi: `npm run build` — 2b10d34

#### Manual

- [x] 2.3 NavBar widoczny i identyczny na `/`, `/dashboard`, `/generate`, `/flashcards`, `/review`
- [x] 2.4 NavBar niewidoczny na stronach auth
- [x] 2.5 Zalogowany: email + Sign out, brak Sign in/Sign up
- [x] 2.6 Niezalogowany: Sign in/Sign up, brak emaila/Sign out
- [x] 2.7 Hamburger menu działa na mobile viewport
- [x] 2.8 Aktywna strona wyróżniona w menu

### Phase 3: Czyszczenie strony głównej

#### Automated

- [x] 3.1 Lint przechodzi: `npm run lint` — 6739500
- [x] 3.2 Build przechodzi: `npm run build` — 6739500

#### Manual

- [x] 3.3 Strona główna pokazuje tylko NavBar + hero
- [x] 3.4 Brak przycisków Sign In/Sign Up w treści strony
- [x] 3.5 Zalogowany użytkownik na `/` nie widzi przycisków logowania/rejestracji

### Phase 4: Redesign dashboardu

#### Automated

- [x] 4.1 Lint przechodzi: `npm run lint` — 10e13a1
- [x] 4.2 Build przechodzi: `npm run build` — 10e13a1

#### Manual

- [x] 4.3 Poprawne liczby fiszek i due-today dla konta z kartami
- [x] 4.4 Poprawny zero-state dla konta bez fiszek, bez błędów w konsoli
- [x] 4.5 CTA "Wygeneruj nowe fiszki" prowadzi do `/generate`
- [x] 4.6 Wygląd spójny ze stylem cosmic-glass
