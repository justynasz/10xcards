...
- **S-04: user can zażądać usunięcia konta; app usuwa wszystkie rekordy użytkownika (fiszki, dane sesji SR), niszczy sesję auth i wylogowuje. Żądanie jest nieodwracalne i wymaga potwierdzenia.** — Archived 2026-07-01 → `context/archive/2026-06-18-account-deletion/`. Lesson: —.
